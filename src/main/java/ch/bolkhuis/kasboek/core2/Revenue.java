...
public class Revenue extends CreditEntry {
     ...
     */
    public Revenue(int id, @NotNull String name, double balance) throws IllegalArgumentException {
        super(name, balance);
    ...
    @Override
    Revenue debit(double amount) throws IllegalArgumentException {
        return new Revenue(id, getName(), debitChange(amount));
    }

    @Override
    Revenue credit(double amount) throws IllegalArgumentException {
