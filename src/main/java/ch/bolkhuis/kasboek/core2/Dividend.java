...
public class Dividend extends DebitEntry {
     ...
     */
    public Dividend(int id, @NotNull String name, double balance) throws IllegalArgumentException {
        super(name, balance);
    ...
    @Override
    Dividend debit(double amount) throws IllegalArgumentException {
        return new Dividend(id, getName(), debitChange(amount));
    }
